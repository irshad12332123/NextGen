...
function ReviewCard() {
  return (
    <div className="rounded-xl md:border-gray-300 md:border-1 md:p-5 hover:border-blue-600 hover:shadow-[0_0_10px_rgb(120,120,255)] transition-all duration-100 w-full">
